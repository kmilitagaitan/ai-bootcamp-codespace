...
96
8.9
Assigning new values to string variables
. . . . . . . . . . . . .
96
...
9.4
Operations on structures . . . . . . . . . . . . . . . . . . . . . . . 105
9.5
Structures as parameters . . . . . . . . . . . . . . . . . . . . . . . 105
9.6
Call by value
. . . . . . . . . . . . . . . . . . . . . . . . . . . . . 106
9.7
...
Rectangles . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . 108
9.9
Structures as return types . . . . . . . . . . . . . . . . . . . . . . 109
...
leave the text editor and run the compiler.
The compiler would read your
...
between the quotation marks will get printed.
Notice the \n after the last
...
successfully.
For example, if you misspell stdio.h, you might get an error
...
name, but I did ﬁnd something named stdio.h. Is that what you
meant, by any chance?”
...
Also called “machine language” or “assembly
language.”
...
statement.
To do this, we need to put placeholders in the so called format
string, that indicate the position where the variable value will be put.
The
...
value 1.0, even though they seem to be the same number.
They belong to
...
...
pi = 10.999;
/* probably a logical error in your program */
...
...
PI = 10.999;
/* wrong, error caught by the compiler
*/
...
call it main or any other C keyword.
The list of parameters speciﬁes what
...
which outputs a newline character.
...
of statements.
Functions can simplify a program by hiding a complex
...
to go oﬀand execute the statements in PrintThreeLines(). But while we are
executing PrintThreeLines(), we get interrupted three times to go oﬀand
execute PrintNewLine().
Fortunately, C is adept at keeping track of where it is, so each time
PrintNewLine() completes,
the program picks up where it left oﬀin
...
Parameters and variables only exist inside their own functions.
Within the
conﬁnes of main(), there is no such thing as phil. If you try to use it, the
...
little diﬀerent from mathematical symbols like =, ̸= and ≤. A common error
...
int quotient = 7 / 3;
int remainder = 7 % 3;
The ﬁrst operator, integer division, yields 2.
...
less, nested conditionals get diﬃcult to read very quickly. In general, it is a
...
or local variables.
As an exercise, draw a stack diagram for PrintLines(),
...
that every possible path through the program hits a return statement.
For
example:
double AbsoluteValue (double x)
{
...
Exercise 6.4
One way to evaluate e−x2 is to use the inﬁnite series expansion
...
Here is the eﬀect of this code
fragment:
c
7
14
...
points.
As an exercise, you might want to think about how to generate a
...
unusual.
We pass an array to this function and expect to get a a random-
...
Exercise 7.2
Write a function that takes an array of integers, the length of the
...
int number = 5;
int *i_p;
This code-fragment deﬁnes an int variable and a pointer.
We can use the
...
the second string.
We do this by deﬁning the maximum capacity for string
...
ematical point.
At one level, a point is two numbers (coordinates) that we
...
It is a common error to leave oﬀthe semi-colon at the end of a structure deﬁni-
...
ping the two coordinates.
The most obvious (but incorrect) way to write a
...
Exercise 9.2
Write a program, that deﬁnes a struct Person_t.
This struct should contain two
members.
The ﬁrst member should be a string of suﬃcient length, to contain the
name of a person.
The second member should be an integer value containing the
persons age.
...
and not equality.
Others reﬂect underlying limitations of the compila-
